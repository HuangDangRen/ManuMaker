...
public abstract class CamAbstr implements CamInterface {

	protected Map<String, Image> thumbnails = new HashMap<String, Image>();
	...
	protected static Image convertToFxImg(BufferedImage nImg) {
		if(!(nImg == null))
			...
			return new Image("file:BlankImage.png");
	}
